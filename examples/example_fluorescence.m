...
% Frequency range
alphaex = 1.56;freqex = alphaex * (299792458/(2*pi)) / ObjProperties.Radius;
alphafluo = 1.0;freqfluo = alphafluo * (299792458/(2*pi)) / ObjProperties.Radius;
...
U = fvc_fluorescence(DIRECTIONS,freqfluo,r,EMT,OPTIONS,Nphoton,Etot);
